    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text("Deals of the day",style: myStyle(23),),
            RegularText(
              text: 'See All',
        ...
        StreamBuilder<List<ProductModel>>(
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                shrinkWrap: true, // Allows the ListView to be as small as possible
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              title: Column(
                                ...
                                children: [
                                  Text('${product.name}',style: myStyle(22),),
                                  Text("By Adidas",style: myStyle(21,Colors.grey),),
                                ],
                              ),
                              subtitle: Row(
                                children: [
