  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title:Text("Add Address",style: myStyle(30,Colors.white),)
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text("Add Address",style: myStyle(25),),
                Gap(8),
      ...
      bottomNavigationBar: ClipRRect(
        ...
        child: BottomAppBar(color: Colors.blue.withOpacity(0.3),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        'ADD ADDRESS',style: myStyle(20,Colors.white),
                      ),
                    ),
                  ),
                ),
