    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Expanded(
              child:Text(product.name,style: myStyle(30,Colors.white),)
            ),
          ],
        ),
        actions: [
              ...
              Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text('${product.name}',style: myStyle(28),),
                      Text('\$ ${product.newPrice}',style: myStyle(23),),
                    ],
                  ),
                  Gap(10),
                  Row(
                  ...
                  Gap(20),
                  Text("Select Size",style: myStyle(25),),
                  Gap(10),
                  Row(
                    children: [
                      buildSizeOption('S'),
                  ...
                  Gap(20),
                  Text("Description",style: myStyle(25),),
                  Gap(10),
                  Text('${product.description}',style: myStyle(22,Colors.grey),),
                  Gap(20),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20)),
                        child: Center(
                          child:Text("Add to Cart",style: myStyle(20,Colors.white),) 
                        ),
                      ),
                    ),
                  ),
